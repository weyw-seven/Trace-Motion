 ...
 *
 * Build note:
 *   These IMPLEMENTATION macros must exist exactly once in the project.
 *   If your project already defines one of them in another .c file,
 *   remove the corresponding define below.
 */
